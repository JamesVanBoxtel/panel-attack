...
Game =
  ...
  function(self)
    ...
    self.TASMode = true
    self.TASIdles = 3 -- the amount of idle inputs after player input before the player can input again
    self.TASSpeed = 6 -- this many ticks the game will proceed anyways, go really high to avoid that
