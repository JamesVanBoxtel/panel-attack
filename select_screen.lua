...
function select_screen.main()
  ...
  while true do
    ...
    if select_screen.character_select_mode == "1p_vs_yourself" then
      ...
      draw_number(GAME.scores:lastVsScoreForLevel(cursor_data[1].state.level), themes[config.theme].images.IMG_number_atlas_1P, 10, {}, xPosition1, yPosition + atlasHeight + 4, 1)
      ...
      draw_number(GAME.scores:recordVsScoreForLevel(cursor_data[1].state.level), themes[config.theme].images.IMG_number_atlas_1P, 10, {}, xPosition2, yPosition + atlasHeight + 4, 1)
    end
