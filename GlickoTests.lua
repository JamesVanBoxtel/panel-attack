...
local function expectedOutcome() 
  ...
  assert(round(updatedPlayer1:expectedOutcome(updatedPlayer2), 2) == 0.76)
  assert(round(updatedPlayer2:expectedOutcome(updatedPlayer1), 2) == 0.24)

  local player3 = Glicko2.g1(2000, 40)
  local player4 = Glicko2.g1(1500, 350)

  assert(round(player3:expectedOutcome(player4), 2) == 0.87)

  local player4 = Glicko2.g1(2000, 40)
  local player5 = Glicko2.g1(600, 40)

  assert(round(player4:expectedOutcome(player5), 4) == .9996)

  local player6 = Glicko2.g1(2500, 40)
  local player7 = Glicko2.g1(1500, 40)

  assert(round(player6:expectedOutcome(player7), 4) == .9965)
end 
